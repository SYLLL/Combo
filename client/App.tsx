...
// Compliance Review Page with original comprehensive functionality
function ComplianceReviewPage() {
  ...
  // Dynamic compliance analysis data
  const [analysis, setAnalysis] = useState({
    status: "pending",
    message: "Upload a PRD to generate compliance analysis",
    details: [],
  });
  ...
  const [schemaData, setSchemaData] = useState({
    ...
    notes: ["Upload a PRD to analyze API schema compliance"],
    suggestions: ["Generate legal review to get specific recommendations"],
    mitigations: ["Analysis will provide targeted mitigation strategies"],
  });

  const [legalReview, setLegalReview] = useState({
    facts: [
      "Upload a Product Requirements Document (PRD) to begin analysis",
      "Click 'Generate Legal Review' to analyze compliance",
    ],
    notes: ["Compliance analysis will be generated based on your PRD"],
    suggestions: ["Review will provide specific compliance recommendations"],
    mitigations: [
      "Analysis will identify required compliance measures",
      "Recommendations will be tailored to your product",
    ],
  });

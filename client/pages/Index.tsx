...
export default function Index() {
  ...
  const handleGenerateCompliance = async () => {
    ...
    setGenerationStatus('Generating compliance analysis...');
    ...
    try {
      ...
      const result = await response.json();
      setGenerationStatus('Compliance analysis generated successfully!');
      setUploadStatus({
        type: 'success',
      ...
      setUploadStatus({
        type: 'error',
        message: 'Failed to generate compliance analysis',
      });
    } finally {
